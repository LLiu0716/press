...
const pagesData$1 = {
  ...
  "v-3df50e69": () => __vitePreload(() => import(
    ...
    "./index.html-ce8b73c9.js"
  ), true ? [] : void 0).then(({ data }) => data),
  // path: /node/koa/
  "v-178fb966": () => __vitePreload(() => import(
    /* webpackChunkName: "v-178fb966" */
    "./index.html-7f7e32ba.js"
  ), true ? [] : void 0).then(({ data }) => data),
  // path: /web/react/
  "v-1ff71564": () => __vitePreload(() => import(
    /* webpackChunkName: "v-1ff71564" */
    "./index.html-16a0b569.js"
  ), true ? [] : void 0).then(({ data }) => data),
  // path: /web/tool/
  "v-7d07e043": () => __vitePreload(() => import(
    /* webpackChunkName: "v-7d07e043" */
    "./index.html-e42d9afb.js"
  ), true ? [] : void 0).then(({ data }) => data),
  // path: /web/vue/
  "v-ad9a6986": () => __vitePreload(() => import(
    /* webpackChunkName: "v-ad9a6986" */
    "./index.html-978381eb.js"
  ), true ? [] : void 0).then(({ data }) => data),
  // path: /404.html
  "v-3706649a": () => __vitePreload(() => import(
    /* webpackChunkName: "v-3706649a" */
    "./404.html-d1da943c.js"
  ), true ? [] : void 0).then(({ data }) => data)
};
const siteData$1 = JSON.parse('{"base":"/press/","lang":"zh-CN","title":"liu0716 的个人博客","description":"","head":[["link",{"type":"image/svg","rel":"icon","href":"/press/favicon.svg"}],["meta",{"name":"keywords","content":"前端,游戏,Vue,React,Node,前端项目规范化工具配置,Koa"}],["meta",{"name":"viewport","content":"width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"}],["meta",{"name":"robots","content":"index,follow"}],["meta",{"name":"og:title","content":"liu0716 的个人博客"}],["meta",{"name":"url","content":"https://liu0716.gitee.io/press/"}],["meta",{"name":"og:url","content":"https://lliu0716.github.io/press/"}]],"locales":{}}');
const pagesComponents = {
  ...
  "v-72027ecc": defineAsyncComponent(() => __vitePreload(() => import(
    /* webpackChunkName: "v-72027ecc" */
    "./index.html-6f926197.js"
  ), true ? ["assets/index.html-6f926197.js","assets/framework-f3b08abd.js"] : void 0)),
  // path: /game/mine-clearance/
...
var withBase = (url) => {
  if (isLinkHttp(url))
    return url;
  return `${"/press/"}${removeLeadingSlash(url)}`;
};
function r(r2, e, n) {
  var i, t, o;
...
const themeData$1 = JSON.parse('{"logo":"./favicon.svg","sidebar":[{"text":"主页","link":"/"},{"text":"web分享","link":"/web","children":[{"text":"开发规范化工具配置","link":"/web/tool"},{"text":"Vue","link":"/web/vue"},{"text":"React","link":"/web/react"}]},{"text":"node分享","link":"/node","children":[{"text":"node","link":"/node"},{"text":"Koa","link":"/node/koa"}]},{"text":"前端与恋爱","link":"/love"},{"text":"游戏分享","link":"/game"}],"navbar":[{"text":"主页","link":"/"},{"text":"web分享","link":"/web"},{"text":"node分享","link":"/node"},{"text":"前端与恋爱","link":"/love"},{"text":"游戏分享","link":"/game"}],"lastUpdatedText":"最近更新时间","backToHome":"返回首页","notFound":["页面丢失"],"lastUpdated":true,"locales":{"/":{"selectLanguageName":"English"}},"colorMode":"auto","colorModeSwitch":true,"repo":null,"selectLanguageText":"Languages","selectLanguageAriaLabel":"Select language","sidebarDepth":2,"editLink":true,"editLinkText":"Edit this page","contributors":true,"contributorsText":"Contributors","openInNewWindow":"open in new window","toggleColorMode":"toggle color mode","toggleSidebar":"toggle sidebar"}');
  ...
  },
  {
    ...
    "headers": [
      ...
      },
      {
        ...
        "link": "#然鹅-当你和一个陌生人搭话-特别是和一个让你心动的异性搭讪",
        "children": []
      },
      {
        "level": 2,
...
const clientConfig8 = {
  enhance: ({ app }) => {
    app.component("Alert", defineAsyncComponent(() => __vitePreload(() => import("./Alert-4a01cd8a.js"), true ? ["assets/Alert-4a01cd8a.js","assets/framework-f3b08abd.js"] : void 0))), app.component("GluttonousSnake", defineAsyncComponent(() => __vitePreload(() => import("./GluttonousSnake-dfb4a23f.js"), true ? ["assets/GluttonousSnake-dfb4a23f.js","assets/framework-f3b08abd.js","assets/Snake-c79073d3.js","assets/Control-63fa8415.js","assets/Alert-4a01cd8a.js"] : void 0))), app.component("Home", defineAsyncComponent(() => __vitePreload(() => import("./Home-bb48004c.js"), true ? ["assets/Home-bb48004c.js","assets/framework-f3b08abd.js","assets/index-2d77be42.js"] : void 0))), app.component("LinkList", defineAsyncComponent(() => __vitePreload(() => import("./LinkList-d17a0834.js"), true ? ["assets/LinkList-d17a0834.js","assets/framework-f3b08abd.js"] : void 0))), app.component("MineClearance", defineAsyncComponent(() => __vitePreload(() => import("./MineClearance-3ba2e06a.js"), true ? ["assets/MineClearance-3ba2e06a.js","assets/framework-f3b08abd.js","assets/Mine-4f5e8663.js"] : void 0))), app.component("OtherComponent", defineAsyncComponent(() => __vitePreload(() => import("./OtherComponent-a56dc8bd.js"), true ? ["assets/OtherComponent-a56dc8bd.js","assets/framework-f3b08abd.js","assets/index-2d77be42.js"] : void 0))), app.component("GluttonousSnake-Control", defineAsyncComponent(() => __vitePreload(() => import("./Control-63fa8415.js"), true ? ["assets/Control-63fa8415.js","assets/framework-f3b08abd.js"] : void 0))), app.component("GluttonousSnake-Snake", defineAsyncComponent(() => __vitePreload(() => import("./Snake-c79073d3.js"), true ? ["assets/Snake-c79073d3.js","assets/framework-f3b08abd.js"] : void 0))), app.component("MineClearance-Mine", defineAsyncComponent(() => __vitePreload(() => import("./Mine-4f5e8663.js"), true ? ["assets/Mine-4f5e8663.js","assets/framework-f3b08abd.js"] : void 0)));
  }
};
...
var createVueRouter = () => {
  const router = createRouter({
    ...
    history: historyCreator(removeEndingSlash("/press/")),
    routes: createRoutes(),
