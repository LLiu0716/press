...
import { r as resolveComponent, o as openBlock, c as createElementBlock, a as createVNode, d as defineComponent, z as usePageFrontmatter, i as computed, A as isArray, u as unref, F as Fragment, f as renderList, g as createBaseVNode, t as toDisplayString, m as createCommentVNode, B as useRoute, C as toRefs, D as createBlock, w as withCtx, E as mergeProps, G as renderSlot, h as createTextVNode, H as isLinkHttp, I as isLinkMailto, J as isLinkTel, K as useSiteData, L as useSiteLocaleData, M as useDarkMode, n as normalizeClass, N as h, O as withBase, P as ClientOnly, x as useRouteLocale, y as useThemeLocaleData, T as Transition, e as ref, k as watch, l as withDirectives, v as vShow, Q as removeLeadingSlash, R as removeEndingSlash, S as useRouter, U as isString, V as useNavLink, b as createStaticVNode, j as onMounted, W as normalizeStyle, X as usePageData, Y as useSidebarItems, Z as isPlainObject, _ as onUnmounted, $ as useScrollPromise } from "./app.92c1248a.js";
...
var HomeContent = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render]]);
const _hoisted_1$e = {
  key: 0,
  class: "features"
};
                ...
                return openBlock(), createElementBlock("li", {
                  ...
                  child.children ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    createBaseVNode("h4", _hoisted_7$1, [
                      child.link ? (openBlock(), createBlock(_sfc_main$g, {
                        key: 0,
                        item: child,
                  ...
                  ], 64)) : (openBlock(), createBlock(_sfc_main$g, {
                    key: 1,
                    item: child,
      ...
      return unref(navbarLinks).length ? (openBlock(), createElementBlock("nav", _hoisted_1$8, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(navbarLinks), (item) => {
          return openBlock(), createElementBlock("div", {
            ...
            item.children ? (openBlock(), createBlock(_sfc_main$b, {
              key: 0,
              item
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("header", {
        ...
        createBaseVNode("div", {
          ...
          renderSlot(_ctx.$slots, "before"),
          createVNode(_sfc_main$a, { class: "can-hide" }),
          renderSlot(_ctx.$slots, "after"),
          unref(enableDarkMode) ? (openBlock(), createBlock(_sfc_main$9, { key: 0 })) : createCommentVNode("", true),
      ...
      return unref(prevNavLink) || unref(nextNavLink) ? (openBlock(), createElementBlock("nav", _hoisted_1$4, [
        createBaseVNode("p", _hoisted_2$1, [
          unref(prevNavLink) ? (openBlock(), createElementBlock("span", _hoisted_3, [
            createVNode(_sfc_main$g, { item: unref(prevNavLink) }, null, 8, ["item"])
          ])) : createCommentVNode("", true),
          unref(nextNavLink) ? (openBlock(), createElementBlock("span", _hoisted_4, [
            createVNode(_sfc_main$g, { item: unref(nextNavLink) }, null, 8, ["item"])
          ])) : createCommentVNode("", true)
        ])
      ])) : createCommentVNode("", true);
    };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("li", null, [
        unref(item).link ? (openBlock(), createBlock(_sfc_main$g, {
          key: 0,
        ...
        ((_a = unref(item).children) == null ? void 0 : _a.length) ? (openBlock(), createBlock(_sfc_main$c, { key: 2 }, {
          default: withCtx(() => [
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        renderSlot(_ctx.$slots, "navbar", {}, () => [
          unref(shouldShowNavbar) ? (openBlock(), createBlock(_sfc_main$7, {
            key: 0,
        ...
        renderSlot(_ctx.$slots, "page", {}, () => [
          unref(frontmatter).home ? (openBlock(), createBlock(_sfc_main$e, { key: 0 })) : (openBlock(), createBlock(Transition, {
            key: 1,
            name: "fade-slide-y",
            mode: "out-in",
